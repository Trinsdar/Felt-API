...
public class FeltOreFeature extends Feature<NoneFeatureConfiguration> {
    ...
    protected boolean generateVeinPart(WorldGenLevel world, RandomSource random, FeltOreFeatureConfig config, double startX, double endX, double startZ, double endZ, double startY, double endY, int x, int y, int z, int horizontalSize, int verticalSize) {
        int i = 0;
    ...
    public static boolean shouldPlace(Function<BlockPos, BlockState> posToState, RandomSource random, FeltOreFeatureConfig config, BlockPos.MutableBlockPos pos) {
